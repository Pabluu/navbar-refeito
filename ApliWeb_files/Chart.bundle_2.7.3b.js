...
var exports = module.exports = Element.extend({
	...
	handleEvent: function(e) {
		...
		if (e.type === 'mouseout') {
			...
			if (e.type === 'click') {
				var indexLabel = me._active[0]._index;
				//console.log(me._active[0]._chart.config.data.labels);				
				var aLinks = me._active[0]._chart.config.data.links;
				if (aLinks){
					if (indexLabel < aLinks.length){
						var functionLink = aLinks[indexLabel];
						if (functionLink != ""){
							eval(functionLink);
						}
					}
